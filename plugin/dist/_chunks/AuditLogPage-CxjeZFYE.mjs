  ...
  return /* @__PURE__ */ jsxs("div", { style: styles.container, children: [
    /* @__PURE__ */ jsxs("div", { style: styles.header, children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { style: styles.subtitle, children: "Son 90 günlük sistem audit logları (read-only)" })
      ] }),
      /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: "12px" }, children: [
        /* @__PURE__ */ jsx("button", { style: { ...styles.button, ...styles.secondaryBtn }, onClick: fetchLogs, children: "🔄 Yenile" }),
        /* @__PURE__ */ jsxs(
          "button",
          {
    ...
    /* @__PURE__ */ jsx("div", { style: styles.filterBar, children: /* @__PURE__ */ jsxs("div", { style: styles.filterGrid, children: [
      /* @__PURE__ */ jsxs("div", { style: styles.filterGroup, children: [
        /* @__PURE__ */ jsx("label", { style: styles.label, children: "Başlangıç" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "date",
      ...
      /* @__PURE__ */ jsxs("div", { style: styles.filterGroup, children: [
        /* @__PURE__ */ jsx("label", { style: styles.label, children: "Bitiş" }),
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "date",
      ...
      /* @__PURE__ */ jsxs("div", { style: styles.filterGroup, children: [
        ...
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            style: styles.select,
            children: [
              /* @__PURE__ */ jsx("option", { value: "", children: "Tümü" }),
      ...
      /* @__PURE__ */ jsxs("div", { style: styles.filterGroup, children: [
        /* @__PURE__ */ jsx("label", { style: styles.label, children: "Sonuç" }),
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("option", { value: "", children: "Tümü" }),
              /* @__PURE__ */ jsx("option", { value: "success", children: "Başarılı" }),
              /* @__PURE__ */ jsx("option", { value: "fail", children: "Başarısız" })
            ]
          }
        )
      ] })
    ...
    loading ? /* @__PURE__ */ jsx("div", { style: styles.loader, children: /* @__PURE__ */ jsx("div", { children: "Yükleniyor..." }) }) : logs.length === 0 ? (
      /* Empty State */
      /* @__PURE__ */ jsxs("div", { style: styles.emptyState, children: [
        /* @__PURE__ */ jsx("div", { style: styles.emptyIcon, children: "📭" }),
        /* @__PURE__ */ jsx("h3", { style: styles.emptyTitle, children: "Henüz gösterilecek bir kayıt yok" }),
      ...
      /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsxs("table", { style: styles.table, children: [
          /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("th", { style: styles.th, children: "Sonuç" }),
          ...
          /* @__PURE__ */ jsx("tbody", { children: logs.map((log) => /* @__PURE__ */ jsxs("tr", { children: [
            ...
            /* @__PURE__ */ jsx("td", { style: styles.td, children: /* @__PURE__ */ jsx("span", { style: { ...styles.badge, ...log.result === "success" ? styles.successBadge : styles.failBadge }, children: log.result === "success" ? "✓ Başarılı" : "✗ Başarısız" }) }),
    ...
    selectedLog && /* @__PURE__ */ jsx("div", { style: styles.modal, onClick: () => setSelectedLog(null), children: /* @__PURE__ */ jsxs("div", { style: styles.modalContent, onClick: (e) => e.stopPropagation(), children: [
      ...
      /* @__PURE__ */ jsxs("div", { style: styles.detailGrid, children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: styles.detailItem, children: [
          /* @__PURE__ */ jsx("div", { style: styles.detailLabel, children: "Sonuç" }),
